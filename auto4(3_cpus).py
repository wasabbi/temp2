...
target = "./test_scheduling\(3_cpus\)"

thread1 = 0x12345786	#CPU_index is 0
thread2 = 0x123457dc	#CPU_index is 1
thread3 = 0x12345801	#CPU_index is 2

# hw_bp_addr sched __start_routine
hw_bp1 = [0x123457ba, 3, thread1]	#suggest go_first in thread1
hw_bp2 = [0x123457f8, 2, thread2]
hw_bp3 = [0x12345835, 1, thread3]
